...
“My Dashboard” is the user’s home hub for onboarding and day-to-day tasks. It typically includes:

- A header (“My Dashboard”)
- A left-side rail of sections (e.g., Checklist, Documents, Training, My Schedule, Submit, My Account)
...
- Not all users see all sections (role + organization settings).
- Some sections only appear after onboarding completion.
