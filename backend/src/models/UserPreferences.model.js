    ...
    try {
      ...
      if (existing) {
        ...
        const allowedFields = [
          ...
          'allow_notifications_outside_work_schedule',
          'auto_reply_enabled', 'auto_reply_message',
          'emergency_override',
          'notification_categories',
          'daily_digest_enabled', 'daily_digest_time', 'daily_digest_last_sent_at',
          ...
          'reduced_motion', 'high_contrast_mode', 'larger_text', 'dark_mode', 'theme_preference', 'timezone', 'schedule_default_view', 'layout_density', 'date_format', 'time_format', 'push_notifications_enabled', 'notification_sound_enabled', 'default_landing_page',
          'helper_enabled',
          'nav_hover_menus_enabled',
