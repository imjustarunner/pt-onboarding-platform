    ...
    try {
      ...
      if (existing) {
        ...
        const allowedFields = [
          ...
          'reduced_motion', 'high_contrast_mode', 'larger_text', 'dark_mode', 'timezone', 'schedule_default_view', 'layout_density', 'date_format', 'time_format', 'push_notifications_enabled', 'notification_sound_enabled', 'default_landing_page',
          'helper_enabled',
