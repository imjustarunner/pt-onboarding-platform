...
export async function persistInboundEmail({ inboxId, agencyId, deliveryId, conversationId = null, threadId = null, ownerUserId = null, fromEmail, replyToEmail = null, subject, bodyText, to = [], cc = [], inReplyTo = null, referencesHeader = null, receivedAt = new Date(), attachments = [] }) {
