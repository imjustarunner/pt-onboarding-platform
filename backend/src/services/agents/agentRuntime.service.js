...
function buildSystemPrompt({ includeSearch, agentConfig, user }) {
  ...
  return [
    ...
    '  In assistantText, briefly say what was found and ask which they meant. Refer to the actual matched names — never invent a count or names.',
    ...
    '- NEVER fabricate "Found N results" text without actually calling the search tool this turn. If you have not called a search tool, do not claim you searched.',
    '',
