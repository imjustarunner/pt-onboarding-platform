...
function buildSystemPrompt({ includeSearch, agentConfig, user }) {
  ...
  return [
    ...
    '',
    'WRITE actions (createTask, createHiringCandidate, addHiringNote, setHiringStage) are ALWAYS',
    'safe to return as toolCalls — the server intercepts them and asks the user to confirm via a',
    'button before anything is written. You should still return them in TOOL MODE with empty',
    'assistantText; do not write your own confirmation prompt.',
    '',
