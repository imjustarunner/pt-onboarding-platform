...
export const ITSCO_HIRING_JOBS_BATCH = [
  ...
  },
  {
    ...
    title: 'Mental Health Practicum/Internship - Colorado Springs & Denver',
    shortTitle: 'Practicum/Internship Mental Health Provider',
    city: 'Colorado Springs & Denver',
    state: 'CO',
    roleType: 'Intern',
    tags: ['Practicum', 'Internship', 'Student Training Program', 'Colorado Springs', 'Denver', 'Paid', 'Rolling admission'],
    serviceFocus: 'School-Based Counseling',
