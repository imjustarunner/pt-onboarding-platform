...
import publicMisdirectedEmailReportRoutes from './routes/publicMisdirectedEmailReport.routes.js';
...
import schoolSupportReplyLibraryRoutes from './routes/schoolSupportReplyLibrary.routes.js';
import orgEscalationsRoutes from './routes/orgEscalations.routes.js';
import plannedOutsRoutes from './routes/plannedOuts.routes.js';
...
import contractGeneratorRoutes from './routes/contractGenerator.routes.js';
import employeeEvaluationRoutes from './routes/employeeEvaluation.routes.js';
...
import prehirePortalRoutes from './routes/prehirePortal.routes.js';
...
import publicSchoolEventsKioskRoutes from './routes/publicSchoolEventsKiosk.routes.js';
import publicHiringReferenceRoutes from './routes/publicHiringReference.routes.js';
import discoverySessionsRoutes from './routes/discoverySessions.routes.js';
...
import publicWebsiteAnalyticsRoutes from './routes/publicWebsiteAnalytics.routes.js';
...
import tutoringLearningOsRoutes from './routes/tutoringLearningOs.routes.js';
...
import financeOperationsRoutes from './routes/financeOperations.routes.js';
...
import focusMusicRoutes from './routes/focusMusic.routes.js';
import focusQuotesRoutes from './routes/focusQuotes.routes.js';
import taskTypesRoutes from './routes/taskTypes.routes.js';
import taskActionItemsRoutes from './routes/taskActionItems.routes.js';
import taskProjectsRoutes from './routes/taskProjects.routes.js';
import scheduleBlockAssignmentsRoutes from './routes/scheduleBlockAssignments.routes.js';
import scheduleHoldReasonsRoutes from './routes/scheduleHoldReasons.routes.js';
...
app.use('/api/public/misdirected-email-report', publicMisdirectedEmailReportRoutes);
...
app.use('/api/assessment-deliverables', assessmentDeliverablesRoutes);
...
app.use('/api/task-action-items', taskActionItemsRoutes);
app.use('/api/task-projects', taskProjectsRoutes);
app.use('/api/schedule-block-assignments', scheduleBlockAssignmentsRoutes);
app.use('/api/schedule-hold-reasons', scheduleHoldReasonsRoutes);
...
app.use('/api/platform/business-onboarding', adminBusinessOnboardingRouter);
...
app.use('/api/tutoring-learning-os', tutoringLearningOsRoutes);
...
app.use('/api/contracts', contractGeneratorRoutes);
app.use('/api/evaluations', employeeEvaluationRoutes);
...
app.use('/api/prehire-portal', prehirePortalRoutes);
...
app.use('/api/school-support-reply-library', schoolSupportReplyLibraryRoutes);
app.use('/api/escalations', orgEscalationsRoutes);
app.use('/api/planned-outs', plannedOutsRoutes);
