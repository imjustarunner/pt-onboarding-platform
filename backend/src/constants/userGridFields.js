...
export const USER_GRID_FIELDS = [
  ...
  { key: 'therapy_notes_training_date', label: 'Therapy notes training', group: 'Lifecycle', type: 'date', source: 'lifecycle', infoKey: 'therapy_notes_training_date', editable: true, sortable: true },
  ...
  { key: 'credentialing_date', label: 'Credentialing date', group: 'Lifecycle', type: 'date', source: 'info', infoKey: 'credentialing_date', editable: true, sortable: true },
  { key: 'credentialing_submitted_date', label: 'Credentialing submitted', group: 'Lifecycle', type: 'date', source: 'lifecycle_checklist', checklistKey: 'credentialing_submitted', checklistField: 'completed_at', editable: false, sortable: true },
  { key: 'credentialing_approved_date', label: 'Credentialing approved', group: 'Lifecycle', type: 'date', source: 'lifecycle_checklist', checklistKey: 'credentialing_approved', checklistField: 'completed_at', editable: false, sortable: true },
  ...
  { key: 'bg_ordered_date', label: 'BG ordered', group: 'Background check', type: 'date', source: 'lifecycle_checklist', checklistKey: 'background_check_ordered', checklistField: 'completed_at', editable: false, sortable: true },
  { key: 'bg_fingerprint_date', label: 'Fingerprinting date', group: 'Background check', type: 'date', source: 'info', infoKey: 'provider_fingerprint_date', editable: true, sortable: true },
  { key: 'bg_federal_complete_date', label: 'Federal BG / fingerprint complete', group: 'Background check', type: 'date', source: 'lifecycle_checklist', checklistKey: 'background_check_complete', checklistField: 'completed_at', editable: false, sortable: true },
  { key: 'bg_federal_expires_date', label: 'Federal BG / fingerprint expires', group: 'Background check', type: 'date', source: 'lifecycle_checklist', checklistKey: 'background_check_complete', checklistField: 'expires_at', editable: false, sortable: true },
  { key: 'bg_internal_complete_date', label: 'Internal BG complete', group: 'Background check', type: 'date', source: 'lifecycle_checklist', checklistKey: 'internal_background_check_complete', checklistField: 'completed_at', editable: false, sortable: true },
