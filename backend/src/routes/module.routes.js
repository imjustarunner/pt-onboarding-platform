...
router.post('/:id/assign', requireBackofficeAdmin, [
  ...
  body('role').optional().isIn(['super_admin', 'admin', 'support', 'supervisor', 'clinical_practice_assistant', 'provider_plus', 'staff', 'provider', 'school_staff', 'facilitator', 'intern']).withMessage('Invalid role'),
