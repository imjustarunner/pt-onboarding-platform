...
const validateTemplate = [
  ...
  body('documentType').optional().isIn(['acknowledgment', 'authorization', 'agreement', 'compliance', 'disclosure', 'consent', 'audio_recording_consent', 'administrative']).withMessage('Invalid document type'),
...
const validateUserSpecificUpload = [
  ...
  body('documentType').isIn(['acknowledgment', 'authorization', 'agreement', 'compliance', 'disclosure', 'consent', 'audio_recording_consent', 'administrative']).withMessage('Invalid document type'),
