...
function exportedToUpdatePayload(data) {
  ...
  const map = {
    ...
    terms_url: 'termsUrl',
    platform_hipaa_url: 'platformHipaaUrl',
    ...
    school_portal_events_icon_id: 'schoolPortalEventsIconId',
    school_portal_digital_forms_icon_id: 'schoolPortalDigitalFormsIconId',
    school_portal_calendar_icon_id: 'schoolPortalCalendarIconId',
    school_portal_public_documents_icon_id: 'schoolPortalPublicDocumentsIconId',
    school_portal_announcements_icon_id: 'schoolPortalAnnouncementsIconId',
...
export const updatePlatformBranding = async (req, res, next) => {
  try {
    ...
    const branding = await PlatformBranding.update({
      ...
      organizationLogoUrl,
      organizationLogoPath,
      privacyPolicyUrl: privacyPolicyUrl !== undefined ? (privacyPolicyUrl === null || privacyPolicyUrl === '' ? null : String(privacyPolicyUrl).trim()) : undefined,
      termsUrl: termsUrl !== undefined ? (termsUrl === null || termsUrl === '' ? null : String(termsUrl).trim()) : undefined,
      platformHipaaUrl: platformHipaaUrl !== undefined ? (platformHipaaUrl === null || platformHipaaUrl === '' ? null : String(platformHipaaUrl).trim()) : undefined,
      ...
      schoolPortalEventsIconId: schoolPortalEventsIconId !== undefined ? (schoolPortalEventsIconId === null || schoolPortalEventsIconId === '' ? null : parseInt(schoolPortalEventsIconId)) : undefined,
      schoolPortalDigitalFormsIconId: schoolPortalDigitalFormsIconId !== undefined ? (schoolPortalDigitalFormsIconId === null || schoolPortalDigitalFormsIconId === '' ? null : parseInt(schoolPortalDigitalFormsIconId)) : undefined,
      schoolPortalCalendarIconId: schoolPortalCalendarIconId !== undefined ? (schoolPortalCalendarIconId === null || schoolPortalCalendarIconId === '' ? null : parseInt(schoolPortalCalendarIconId)) : undefined,
      schoolPortalPublicDocumentsIconId: schoolPortalPublicDocumentsIconId !== undefined ? (schoolPortalPublicDocumentsIconId === null || schoolPortalPublicDocumentsIconId === '' ? null : parseInt(schoolPortalPublicDocumentsIconId)) : undefined,
      schoolPortalAnnouncementsIconId: schoolPortalAnnouncementsIconId !== undefined ? (schoolPortalAnnouncementsIconId === null || schoolPortalAnnouncementsIconId === '' ? null : parseInt(schoolPortalAnnouncementsIconId)) : undefined,
