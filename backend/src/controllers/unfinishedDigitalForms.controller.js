import { getUnfinishedDigitalFormsSnapshot } from '../services/unfinishedDigitalForms.service.js';
...
export const getSnapshot = async (req, res, next) => {
  try {
    ...
    const snapshot = await getUnfinishedDigitalFormsSnapshot(agencyId, {
      scope: req.query?.scope || 'all',
      schoolOrganizationId: req.query?.schoolOrganizationId || req.query?.schoolId || null
    });
