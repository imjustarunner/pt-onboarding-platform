...
export const createAgency = async (req, res, next) => {
  try {
    ...
    const agency = await Agency.create({ 
      ...
      onboardingTeamEmail, supportTeamEmail,
      phoneNumber,
      phoneExtension,
      portalUrl,
      customDomain,
