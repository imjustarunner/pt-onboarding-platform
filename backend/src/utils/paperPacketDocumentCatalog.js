 ...
 * One-signature packet forms + separate ROI.
 *
 * Legacy client_paperwork_items keys (re_auth, renewal, emailed_packet, balance,
 * disclosure_consent, etc.) are not used in the readiness workspace.
 */
