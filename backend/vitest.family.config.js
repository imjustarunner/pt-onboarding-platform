export default {
  ...
  test: { environment: 'node', include: ['src/services/__tests__/familyEmailRouting.test.js', 'src/services/__tests__/familyEmail.test.js', 'src/services/__tests__/familyPolicy.test.js', 'src/services/__tests__/familyAuth.test.js', 'src/services/__tests__/family.service.test.js', 'src/services/__tests__/familyHomeTools.test.js', 'src/services/__tests__/familyCalendar.test.js'], restoreMocks: true }
};
