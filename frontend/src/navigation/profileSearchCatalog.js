...
export const PROFILE_SEARCH_TARGETS = [
  ...
  { id: 'supervisor-assignments', tabId: 'provider_info', sectionId: '', clinicalSubTab: 'supervision', label: 'Supervisor assignments', aliases: ['supervisor assignment', 'supervisees'] },
