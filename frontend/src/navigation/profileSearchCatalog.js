...
export const PROFILE_SEARCH_TARGETS = [
  ...
  { id: 'licenses', tabId: 'provider_info', sectionId: '', clinicalSubTab: 'license_certifications', label: 'Licenses & Certifications', aliases: ['license', 'licenses', 'credential', 'lpcc', 'lcsw', 'certification', 'pdf', 'license upload', 'license pdf'] },
  ...
  { id: 'supervisor-assignments', tabId: 'assignments', sectionId: 'supervisor-assignments', label: 'Supervisor assignments', aliases: ['supervisor assignment', 'supervisees'] },
  { id: 'agency-assignments', tabId: 'assignments', sectionId: 'agency-assignments', label: 'Agency assignments', aliases: ['agencies', 'agency assignment'] },
  { id: 'building-offices', tabId: 'assignments', sectionId: 'building-offices', label: 'Building offices', aliases: ['offices', 'building', 'office assignment'] },
  ...
  { id: 'assignments', tabId: 'assignments', sectionId: '', label: 'Assignments', aliases: ['school', 'program', 'learning', 'affiliation', 'affiliations'] },
  ...
  { id: 'clients', tabId: 'clients', sectionId: '', label: 'Clients', aliases: ['caseload', 'school clients', 'office clients', 'assigned clients'] },
  ...
  { id: 'clinical-license', tabId: 'provider_info', sectionId: '', clinicalSubTab: 'license_certifications', label: 'License & certifications', aliases: ['license', 'licenses', 'lpcc', 'license pdf'] },
  { id: 'clinical-supervision', tabId: 'provider_info', sectionId: '', clinicalSubTab: 'supervision', label: 'Clinical supervision', aliases: ['supervisor', 'supervision assignments', 'supervision notes'] },
