<template>
  <div class="ohub">
    ...
    <template v-if="viewMode === 'tracker'">
      ...
      <div class="ohub-body">
        ...
        <aside v-if="selected" class="ohub-detail">
          <div class="ohub-detail-head">
            ...
            <button type="button" class="btn-link" @click="selectedId = null">Close</button>
          </div>
          ...
          <button type="button" class="btn btn-secondary" @click="startTripFromSchool(selected)">Plan trip from this school</button>
    ...
    <template v-else-if="viewMode === 'trips'">
      ...
      <ul class="ohub-saved-trips">
        <li v-for="t in trips" :key="t.id" class="ohub-saved-trip">
          ...
          <button
            ...
            class="btn btn-primary"
            :disabled="tripSaving"
            @click="completeTrip(t)"
          >Mark complete (log visits)</button>
        </li>
...
const completeTrip = async (t) => {
  tripSaving.value = true;
  try {
    await api.post(`/outreach/trips/${t.id}/complete`, {
