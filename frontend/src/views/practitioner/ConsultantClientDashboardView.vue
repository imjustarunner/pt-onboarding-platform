<template>
  ...
  >
    ...
    <section v-if="currentSection==='dashboard'" class="card"><h2 class="journey-message-title">Secure messages</h2><p class="muted">Stay in touch with your consultant and review the guidance shared with you.</p><button class="ps-btn" @click="openSection('messages')">Open conversations →</button></section>
    </div>
  </PractitionerShell>
</template>
