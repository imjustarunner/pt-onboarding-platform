        ...
        <template v-if="!invite.submitted || currentStep !== 'home'">
          ...
          <section v-else-if="currentStep === 'school_staff'" class="so-panel">
            ...
            <div v-for="(row, idx) in staffRows" :key="idx" class="so-staff-card">
              ...
              <label class="block">
                Job title <span class="muted tiny">(optional)</span>
                <input v-model.trim="row.jobTitle" placeholder="e.g. Counselor, Assistant Principal" maxlength="255" />
                <span class="muted tiny">
                  If you leave this blank, they will be asked for a title when they set their password.
                </span>
              </label>
          ...
          <section v-else-if="currentStep === 'review_submit'" class="so-panel">
            ...
            <div v-if="!invite.passwordSet" class="so-password-final">
              ...
              <p class="muted tiny so-password-privacy">
                This is <strong>your</strong> personal login password. Staff you added will get their own
                email link to set a password after you submit — keep yours private.
