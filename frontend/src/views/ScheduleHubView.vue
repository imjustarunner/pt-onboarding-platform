  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        shortDesc: 'Join Client Enrollment counseling intake master.',
        desc: 'Counseling digital intake master (EN/ES) used by Join → Client Enrollment Packet. Separate from school and tutoring masters.',
        cta: 'Open →',
      ...
      {
        id: 'unfinished-digital-forms',
        title: 'Unfinished Digital Forms',
        shortDesc: 'Office enrollment packets still in progress.',
        desc: 'Track unfinished Client Enrollment Packets, reminder sequence status, and draft expiry for office digital forms.',
        cta: 'Open →',
        to: orgTo('/admin/unfinished-digital-forms?scope=office'),
        tone: 'orange',
        icon: icon.docs || icon.onboard || icon.clients,
        tour: null,
        show: canSeeClientsManagementHub.value,
...
.hub-center.tone-orange {
  ...
  background: radial-gradient(circle at 50% 30%, var(--app-surface-muted, #fff7ed) 0%, var(--app-surface, #ffffff) 58%);
  box-shadow:
    0 0 0 8px rgba(255, 255, 255, 0.65),
    0 0 48px rgba(249, 115, 22, 0.2),
    0 20px 50px rgba(249, 115, 22, 0.1);
}
.hub-center.tone-root .hub-center-icon { background: var(--app-surface-muted, #f1f5f9); color: var(--app-muted, #475569); }
.hub-center.tone-purple .hub-center-icon { background: var(--app-surface-muted, #f1f5f9); color: var(--app-muted, #475569); }
...
.hub-center.tone-orange .hub-center-icon { background: var(--app-surface-muted, #fff7ed); color: var(--app-text-red, #c2410c); }
...
.tone-purple .hub-satellite-icon { background: var(--app-surface-muted, #f1f5f9); color: var(--app-muted, #475569); }
...
.tone-purple .hub-satellite-pill { background: var(--app-surface-muted, #f1f5f9); color: var(--app-muted, #475569); }
...
.tone-orange .hub-satellite-pill { background: var(--app-surface-muted, #fff7ed); color: var(--app-text-red, #c2410c); }
.tone-teal .hub-satellite-pill { background: var(--app-surface-muted, #f0fdfa); color: var(--app-text-green, #0f766e); }
.tone-indigo .hub-satellite-pill { background: var(--app-surface-muted, #ecfeff); color: var(--app-text-blue, #0e7490); }
...
.hub-preview.tone-orange { border-color: var(--app-line, #fdba74); }
...
@media (max-width: 820px) {
  ...
  .tone-purple .hub-mobile-icon { background: var(--app-surface-muted, #f1f5f9); color: var(--app-muted, #475569); }
