<template>
  <div class="club-manager-signup" :style="{ background: loginBackground }">
    <div class="signup-card">
      ...
      <h1>Create Club Manager Account</h1>
...
const displaySubtitle = computed(() => {
  ...
  return `Sign up to create and manage your fitness club on ${name}.`;
});
...
const submit = async () => {
  ...
  try {
    ...
    success.value = r.data?.message || 'Account created. Please check your email to verify before creating your club.';
    if (r.data?.verifyUrl) {
