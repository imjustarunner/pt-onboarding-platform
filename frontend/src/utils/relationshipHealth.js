/**
 * Pure Relationship Health scoring & comparison (mirrors backend).
 */

export const MODE_OPTIONS = [
  { id: 'full', label: 'Full Relationship Health Assessment', time: '15–25 min each', description: 'Ten domains with shared comparison and growth plan.' },
  { id: 'quick', label: 'Quick Relationship Check-In', time: '5–8 min', description: 'Shorter rotating check-in for trends.' },
  { id: 'premarital', label: 'Premarital Assessment', time: '15–20 min', description: 'Communication, trust, conflict, finances, and shared vision.' },
  { id: 'parenting', label: 'Parenting Partnership Review', time: '10–15 min', description: 'Parenting teamwork and couple connection.' },
  { id: 'rebuilding-trust', label: 'Rebuilding Trust Review', time: '12–18 min', description: 'Safety, reliability, and repair — without requiring reconciliation.' },
  { id: 'transition', label: 'Relationship Transition Review', time: '12–18 min', description: 'For major life changes affecting the partnership.' }
];
...
export function interpretScore(score, labels = {}) {
  ...
  if (score <= 3) return labels.low || 'Significant concern in this area';
  if (score <= 6) return labels.mid || 'Mixed or inconsistent experience';
  return labels.high || 'Generally positive experience';
}
