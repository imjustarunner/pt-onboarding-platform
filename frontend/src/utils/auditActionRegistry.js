...
export const AUDIT_ACTION_REGISTRY = {
  ...
  office_billing_sites_transitioned: { label: 'Office billing sites moved to replacement office', category: 'Office & Scheduling' },
  ...
  downloaded: { label: 'Legacy download event (retrieval unverified)', category: 'Documents' },
  download_link_issued: { label: 'Document download link issued', category: 'Documents' },
  ...
  // AI & Tools
  client_intake_note_generated: { label: 'Client intake note AI draft generated', category: 'AI & Tools' },
  client_intake_note_diagnosis_remain: { label: 'Client intake diagnosis kept as-is', category: 'AI & Tools' },
  ...
  client_staff_onboarding_completed: { label: 'Client staff onboarding completed', category: 'Client Access' },
  client_paper_packet_signature_received: { label: 'Paper packet signature marked received', category: 'Client Access' },
  client_roi_staff_onboarding_acknowledged: { label: 'School ROI staff permissions acknowledged', category: 'Client Access' },
