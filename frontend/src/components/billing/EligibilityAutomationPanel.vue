...
<style scoped>
.automation{background:var(--bg-card,#fff);border:1px solid var(--border-color,#dde5ef);border-radius:14px;padding:24px;margin:20px 0}header,.state,.toolbar,.fields{display:flex;flex-wrap:wrap;gap:16px;align-items:center}header>div{flex:1;min-width:250px}h2{margin:0 0 12px}p,small,li{line-height:1.6}.state,.hint{padding:14px;background:var(--bg-secondary,#eff5fb);border-radius:8px}.state span,small{color:var(--text-secondary,#52617a);font-size:13px}label{display:flex;flex-direction:column;gap:8px;margin:14px 0}.check{flex-direction:row;align-items:center}input:not([type=checkbox]),select,button{font:inherit;padding:10px;border:1px solid var(--border-color,#c4d0df);border-radius:6px;min-height:40px}button{cursor:pointer;color:var(--bw-brand,#2463ad);background:var(--bg-card,#fff)}button:disabled{opacity:.5;cursor:default}small{display:block;margin:8px 0}.table-scroll{overflow:auto}table{width:100%;border-collapse:collapse}td,th{padding:12px;text-align:left;border-bottom:1px solid var(--border-color,#dde5ef)}[role=alert]{color:#b91c1c}summary{cursor:pointer;font-weight:600}li{margin:8px 0}
</style>
