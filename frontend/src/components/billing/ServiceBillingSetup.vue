...
<style scoped>
.service-setup .card{padding:24px;border:1px solid #d9e2ef;background:var(--bg-card);border-radius:12px;margin:20px 0}.service-setup .fields{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:16px}.service-setup label{display:grid;gap:8px;margin:14px 0}.service-setup input,.service-setup select,.service-setup textarea{font:inherit;min-width:0;box-sizing:border-box;width:100%;padding:10px;border:1px solid #a9bace;border-radius:6px}.service-setup button{padding:11px 16px;border:1px solid #a9bace;background:#edf4fa;color:#16466d;border-radius:7px;font:inherit;cursor:pointer}.service-setup button:disabled{opacity:.5;cursor:default}.service-setup .check{display:flex;align-items:center}.service-setup .check input{width:auto}.service-setup .quote{background:#edf7f4;padding:14px;border-radius:6px}.service-setup .rate-list{display:flex;gap:10px;flex-wrap:wrap}.service-setup [role=alert]{color:#b42318}.service-setup p{line-height:1.6}
</style>
