...
<style scoped>section{padding:12px;border:1px solid #cbd5e1;border-radius:8px;margin:12px 0}button{display:block;margin-top:10px}[role=alert]{color:#a32121}</style>
