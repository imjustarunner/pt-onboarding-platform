...
<style scoped>
.readiness{padding:24px;background:var(--card-bg,#fff);border:1px solid var(--border-color,#d8e1ed);border-radius:12px;margin-bottom:20px}.readiness label{display:grid;gap:8px;margin:16px 0}.readiness select,.readiness textarea{padding:10px;border:1px solid var(--app-line, #aabbd0);border-radius:6px;max-width:640px;font:inherit}.readiness p{max-width:800px;line-height:1.5}.readiness button{padding:10px 16px;font:inherit}.readiness [role=alert]{color:var(--app-text-red, #a21c28)}
</style>
