...
<style scoped>.coverage-check{border-top:1px solid var(--border);padding:16px 0;margin-top:16px}label{display:block;margin:10px 0}button{margin:6px;padding:8px}pre{white-space:pre-wrap;overflow-wrap:anywhere;max-height:22rem;overflow:auto}textarea{display:block;width:100%;min-height:80px}[role=alert]{color:var(--app-text-red, #b91c1c)}</style>
