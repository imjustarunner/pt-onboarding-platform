...
/* Portraits stay beside the provider information at every viewport size. */
.avatar,.avatar-fallback{width:120px;height:180px;border-radius:12px;object-fit:cover;object-position:center top}
.card-identity{align-items:flex-start}
@media(max-width:520px){.card-identity{flex-direction:row;gap:14px}.avatar,.avatar-fallback{width:90px;height:135px}.card-name-wrap{overflow-wrap:anywhere}}
</style>
