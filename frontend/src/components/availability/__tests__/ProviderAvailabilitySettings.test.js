...
const state={preferences:{acceptingNewClients:true,inPerson:true,virtual:true},reminders:[{format:'VIRTUAL',notificationId:3,snoozed:false}],checkedAt:'2026-09-17T16:00:00Z'};
const render=()=>mount(Settings,{props:{providerId:9,agencyId:2},global:{stubs:{RouterLink:{props:['to'],template:'<a :data-to="JSON.stringify(to)"><slot/></a>'}}}});
