...
const removeNavigationGuard=router.beforeEach(()=>{if(dirty.value&&!window.confirm('Discard your unsaved website changes?'))return false;websiteEditor.changes={};stop();});
