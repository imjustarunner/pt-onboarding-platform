...
<style scoped>
.event-type-picker{min-width:0;width:100%}.picker-filters{display:flex;gap:12px;flex-wrap:wrap}.picker-filters>label{flex:1;min-width:130px}.event-type-picker label{display:flex;flex-direction:column;gap:7px;font-size:12px;color:#766b85;margin:8px 0}.event-type-picker input,.event-type-picker select{box-sizing:border-box;width:100%;min-width:0;max-width:100%;font:inherit;background:white;color:#655d76;border:1px solid #ded9e8;border-radius:9px;padding:11px;min-height:44px}.event-type-picker input:focus,.event-type-picker select:focus{outline:2px solid #b7afe2;outline-offset:1px}.event-type-picker p{font-size:11px;color:#84778f;margin:6px 0}
</style>
