...
.detail-artwork{display:block;width:100%;aspect-ratio:3/2;object-fit:cover;border-radius:12px;margin:12px 0}.event-detail{color:var(--ink);background:var(--surface);padding:24px;border:1px solid var(--line);border-radius:16px;max-width:520px;width:calc(100% - 32px);max-height:85dvh;overflow:auto;margin:auto}.event-detail::backdrop{background:#16212b88}.event-detail p{white-space:pre-line;font-size:14px}.event-detail h3{font-size:22px;margin:12px 0}.detail-icon{color:var(--event-ink);background:var(--event-fill);border-left:4px solid var(--event-color);font-size:30px;padding:5px 12px;display:inline-block;border-radius:8px}.close{float:right}.empty{color:var(--muted);font-size:13px;margin:6px 0}.sr-only{position:absolute;width:1px;height:1px;overflow:hidden;clip-path:inset(50%)}
