      ...
      >
        <div class="agency-header">
          <div class="agency-header-content">
            <div v-if="agency.logo_url && !logoErrors[agency.id]" class="agency-logo">
              <img 
                :src="agency.logo_url" 
        ...
        <form @submit.prevent="saveAgency">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div v-if="agencyForm.logoUrl" class="logo-preview-inline">
          ...
          <div class="form-group">
            <label>Icon</label>
            <IconSelector v-model="agencyForm.iconId" label="Select Agency Icon" />
          </div>
          ...
          <div class="settings-section-divider">
            <h4>Default Icons</h4>
            <p class="section-description">
              Set default icons for this agency. These override system-wide defaults. Individual items can still have their own icons.
            </p>
          </div>
          ...
          <div class="settings-section-divider">
            ...
            <p class="section-description">
              Icons displayed on the dashboard quick action cards. These override platform defaults for this agency.
            </p>
          </div>
...
const saveAgency = async () => {
  try {
    ...
    if (agencyForm.value.logoUrl && agencyForm.value.logoUrl.trim()) {
      try {
