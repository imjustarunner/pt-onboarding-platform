-- Summit Stats Challenge: Add 'affiliation' organization type
-- Affiliations are program divisions (Corporate Wellness, School Fitness, etc.) under the Summit Stats Challenge agency.
